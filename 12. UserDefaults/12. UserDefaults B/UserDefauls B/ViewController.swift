...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate & UINavigationControllerDelegate {
    ...
    func fetchImagesFromUserDefaults() {
        ...
        guard let savedPeopleData = defaults.value(forKey: "people") as? Data,
            let decodedPeople = try? jsonDecoder.decode([Person].self, from: savedPeopleData) else { return }
    ...
    func save() {
        ...
        guard let savedData = try? jsonEncoder.encode(self.people) else { return }
